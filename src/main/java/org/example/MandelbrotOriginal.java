 ...
 * @author tvcutsem
 */
public class MandelbrotOriginal extends Canvas {
     ...
     */
    public MandelbrotOriginal(int height, boolean optParallel, boolean optDrawGrid) {
   ...
   public static void run(String args[]) {
        ...
        Frame f = new Frame();
        MandelbrotOriginal canvas = new MandelbrotOriginal(HEIGHT, optParallel, optDrawGrid);
